...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Salty Psychengine port", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Salty Psychengine port", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "25";
		app.meta["company"] = "Salty";
		app.meta["file"] = "Salty Psychengine port";
		app.meta["name"] = "Friday Night Funkin Salty Psychengine port";
		app.meta["packageName"] = "com.salty.funkin";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin Salty Psychengine port",
			width: 1280,
			x: null,
			y: null,
		};
