...
HXLINE(  75)		{
HXLINE(  75)			::String v2 = (::ManifestResources_obj::rootPath + HX_("manifest/best-girl.json",71,07,53,13));
HXDLIN(  75)			::lime::utils::Assets_obj::libraryPaths->set(HX_("best-girl",65,91,48,8e),v2);
            		}
HXLINE(  76)		{
...
HXLINE(  91)		library = ::lime::utils::Assets_obj::getLibrary(HX_("best-girl",65,91,48,8e));
HXLINE(  92)		if (::hx::IsNotNull( library )) {
HXLINE(  92)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  93)			::ManifestResources_obj::preloadLibraryNames->push(HX_("best-girl",65,91,48,8e));
            		}
