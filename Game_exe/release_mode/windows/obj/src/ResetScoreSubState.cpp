...
HXLINE(  53)		if ((week == -1)) {
HXLINE(  53)			text1->set_x((text1->x + (( (Float)(60) ) * tooLong)));
            		}
...
HXLINE(  68)		 ::Alphabet fh = this->yesText;
HXDLIN(  68)		fh->set_x((fh->x - ( (Float)(200) )));
...
HXLINE(  72)		 ::Alphabet fh1 = this->noText;
HXDLIN(  72)		fh1->set_x((fh1->x + 200));
...
HXLINE(  86)			 ::HealthIcon fh = this->icon;
HXDLIN(  86)			fh->set_alpha((fh->alpha + (elapsed * ((Float)2.5))));
            		}
