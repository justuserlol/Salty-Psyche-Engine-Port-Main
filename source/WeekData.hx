...
class WeekData {
	...
	public static var songsNames:Array<Dynamic> = [
		['best-girl'],								//Tutorial, this one isn't added to Freeplay, instead it is added from assets/preload/freeplaySonglist.txt
		['Daddys-Girl', 'Salty-Love', 'Daughter-Complex'],			//Week 1
		['Sweet-n-Spooky', 'Sour-n-Scary', 'Opheebop'],			//Week 2
		['Protect', 'Defend', 'Safeguard'],			//Week 3
		['Indie-Star', 'Rising-Star', 'Superstar'],			//Week 4
		['Order-Up', 'Rush-Hour', 'Freedom'],	//Week 5
		['Buckets', 'Logarithms', 'Terminal']			//Week 6
	];
